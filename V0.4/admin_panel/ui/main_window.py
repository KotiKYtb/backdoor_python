...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.window_tracker_tab = WindowTrackerTab(self.connection_tab)  # Nouvel onglet
        ...
        self.tabs.addTab(self.window_tracker_tab, "🪟 Fenêtre active")  # Ajout du nouvel onglet
